...
| MTP Block Name                  | MTP Parent Type          | Description                                                          | DMC Block Name       | Priority |
| ------------------------------- | ------------------------ | -------------------------------------------------------------------- | -------------------- | -------- |
| [BinMon](specs/BinMon.md)       | IndicatorElement\BinView | display a binary value                                               | fbIO_DigitalInput    | 1        |
| [AnaMon](specs/AnaMon.md)       | IndicatorElement\AnaView | display an analogue value                                            | fbIO_AnalogInput (1) | 1        |
| [MonBinVlv](specs/MonBinVlv.md) | ActiveElement\BinVlv     | bistable valve                                                       | fbValve_Solenoid     | 1        |
| [MonAnaVlv](specs/MonAnaVlv.md) | ActiveElement\AnaVlv     | analogue valve                                                       | fbValve_Analog (2)   | 1        |
| [MonBinDrv](specs/MonBinDrv.md) | ActiveElement\BinDrv     | fixed speed drive with both clockwise and anti-clockwise rotation    | fbMotor_Reversing    | 1        |
| [MonAnaDrv](specs/MonAnaDrv.md) | ActiveElement\AnaDrv     | variable speed drive with both clockwise and anti-clockwise rotation | fbVFD_Analog         | 1        |
| [PIDCtrl](specs/PIDCtrl.md)     | ActiveElement            | continuous PID controller                                            | fbPID_Compact        | 1        |
| [LockView4](specs/LockView4.md) | DiagnosticElement        | visualize the current state of 4 locks                               | fbInterlock (3)      | 1        |
...
| MTP Block Name                  | MTP Parent Type             | MTP Description                                                      | DMC Block Name       | Priority |
| ------------------------------- | --------------------------- | -------------------------------------------------------------------- | -------------------- | -------- |
| IndicatorElement                |                             | visualise PEA-internal values in the POL                             |                      |          |
| BinView                         | IndicatorElement            | display a binary value of the PEA                                    |                      |          |
| [BinMon](specs/BinMon.md)       | IndicatorElement\BinView    | extends BinView with fluttering signal monitoring                    | fbIO_DigitalInput    | 1        |
...
| [AnaMon](specs/AnaMon.md)       | IndicatorElement\AnaView    | extends AnaView with limit check                                     | fbIO_AnalogInput (1) | 1        |
...
| [MonBinVlv](specs/MonBinVlv.md) | ActiveElement\BinVlv        | extends BinVlv with feedback monitoring                              | fbValve_Solenoid     | 1        |
...
| [MonAnaVlv](specs/MonAnaVlv.md) | ActiveElement\AnaVlv        | extends AnaVlv with feedback monitoring                              | fbValve_Analog (2)   | 1        |
| BinDrv                          | ActiveElement               | fixed speed drive with both clockwise and anti-clockwise rotation    |                      |          |
| [MonBinDrv](specs/MonBinDrv.md) | ActiveElement\BinDrv        | extends BinDrv with feedback monitoring                              | fbMotor_Reversing    | 1        |
| AnaDrv                          | ActiveElement               | variable speed drive with both clockwise and anti-clockwise rotation |                      |          |
| [MonAnaDrv](specs/MonAnaDrv.md) | ActiveElement\AnaDrv        | extends AnaDrv with feedback monitoring                              | fbVFD_Analog         | 1        |
| [PIDCtrl](specs/PIDCtrl.md)     | ActiveElement               | continuous PID controller                                            | fbPID_Compact        | 1        |
