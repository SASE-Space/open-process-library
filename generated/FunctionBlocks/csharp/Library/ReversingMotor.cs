...
namespace OpenProcessLibrary
{
    ...
    public class ReversingMotor
    {
        ...
        [Tag] public bool enableForward = true;
        [Tag] public bool enableReverse = false;
        [Tag] public bool driveTrip;
        ...
        public void Execute()
        {
            ...
            DelayTimer1.Execute(FwdFbkCalc && fwdCommand, TimeSpan.FromSeconds(simulateDelay));
            fwdFbkSimulated = DelayTimer1.Q;
            DelayTimer2.Execute(RevFbkCalc && revCommand, TimeSpan.FromSeconds(simulateDelay));
