...
| remoteSource      | x   |     | Output   | Output    |         | 0: operator/local, 1: automatic/remote                                    |          |                                |
| internalSourceAct | x   |     | Output   | Output    |         |                                                                           |          |                                |
| manualSourceAct   | x   |     | Output   | Output    |         |                                                                           |          |                                |
|                   |     |     |          |           |         |                                                                           |          |                                |
...
| OpenAut           | x          | x   |     | open                                                        |                                                           |
| CloseAut          | x          | x   |     | close                                                       |                                                           |
| OpenFbkCalc       | x          | x   |     | simulation OR NOT feedbackOpen                              | TODO: review logic                                        |
