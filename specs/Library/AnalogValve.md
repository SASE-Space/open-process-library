...
| programSelectsSource  | x   |     | Output   | Bool      |         |                                                                           |          |                                |
...
| selectedPosition      |            | x   |     | (PosInt * INT_TO_REAL(BOOL_TO_INT(SrcIntAct))) + (PosMan * INT_TO_REAL(BOOL_TO_INT(SrcManAct)))                         |                                                             |
...
| PosInt                | x          | x   |     | (dynamicSource * INT_TO_REAL(BOOL_TO_INT(dynamicSourceAct))) + (fixedSource * INT_TO_REAL(BOOL_TO_INT(fixedSourceAct))) |                                                             |
| PosFbk                | x          | x   |     | (positionOut * INT_TO_REAL(BOOL_TO_INT(simulate))) + (feedbackPosition * INT_TO_REAL(BOOL_TO_INT(simulate)))            |                                                             |
| positionOut           | x          | x   |     | Pos                                                                                             |                                                             |
